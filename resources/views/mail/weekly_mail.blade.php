...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">You are receiving this email from your Product</p>
...
<td> To Email : {{$data->to_email}}</td>
<td> title :  {{$data->title}}</td>
<td> From : {{$data->user->username}}</td>
<td> Country :{{$data->country}}</td>
<td> Checked : {{ $data->checked ? 'true' : 'false'  }}</td>
